...
public class SmoothCamera : MonoBehaviour {
    ...
    private VuforiaARController _vuforia;
	...
	void Start ()
    {
		...
		_vuforia = VuforiaARController.Instance;
...
//		qcarBehavior.RegisterTrackablesUpdatedCallback(OnTrackablesUpdated);
		...
		_vuforia.RegisterVuforiaStartedCallback(OnInitialized);
		_vuforia.RegisterTrackablesUpdatedCallback (OnTrackablesUpdated);
	}
